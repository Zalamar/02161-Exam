...
Scenario: try to add time to a not selected activity 
	When a worker added the start date 221118 
	Then I get the manageActivityTime error message "No activity is selected" 
	
Scenario: try to add time to a not selected activity 
	When a worker added the end date 221118 
	Then I get the manageActivityTime error message "No activity is selected"